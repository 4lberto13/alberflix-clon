      ...
      >
        <div className="pt-24 md:pt-0">
          ...
          <p className="max-w-md mt-2 text-xs md:text-base">
            Esto es un clon de Netfliz creado desde cero, aprendiendo todas las tecnologías
            necesarias para ello. Es un poyecto FullStack con las tecnologías Nextjs 14,
            React, Tailwind, NextAuth y Prisma. Esta creado por mi y guiado y revisado por 
            otro programador tambien junior. Espero que lo disfrutes.
          </p>
